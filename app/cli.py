...
def init_admin(
    ...
    password: Optional[str] = typer.Option(None, "--password", "-p", help="Admin password (will prompt if not provided)"),
    full_name: Optional[str] = typer.Option(None, "--full-name", "-n", help="Admin full name"),
...
def setup(
    ...
    password: Optional[str] = typer.Option(None, "--password", "-p", help="Admin password (will prompt if not provided)"),
    full_name: Optional[str] = typer.Option("System Administrator", "--full-name", "-n", help="Admin full name"),
) -> None:
