...
class TestOAuth2Schemas:
    ...
    def test_local_login_request(self):
        ...
        request_data = {"email": "user@example.com", "password": "password123"}
    ...
    def test_refresh_token_request(self):
        ...
        request_data = {"refresh_token": "refresh-token-123"}
...
class TestOAuth2Endpoints:
    ...
    async def test_authorize_local_invalid_credentials(self):
        ...
        with patch("app.api.v1.endpoints.auth.AuthService") as mock_service_class:
            mock_service = AsyncMock()
            mock_service.authorize_local = AsyncMock(
    ...
    async def test_token_exchange_local_success(self):
        ...
        with patch("app.api.v1.endpoints.auth.AuthService") as mock_service_class:
            mock_service = AsyncMock()
            mock_service.exchange_local_authorization_code = AsyncMock(
            ...
            mock_service.exchange_local_authorization_code.assert_awaited_once_with(
                auth_code
            )
